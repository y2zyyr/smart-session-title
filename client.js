...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var en = {
      ...
      "settings.subtitle": "Choose a model and set your preferred title format.",
      ...
      "batch.summary": "Select past sessions to regenerate their titles.",
...
.sst-settings .sst-advanced { padding: 12px 18px; }
.sst-advanced > div > button { display: block; width: 100%; text-align: left; min-height: 24px; }
.sst-settings .sst-batch > summary { color: inherit; font-size: 14px; font-weight: 500; }
.sst-batch-summary { display: block; margin: 4px 0 0 16px; font-size: 12px; font-weight: 400; color: var(--dsw-alias-label-tertiary); }
.sst-batch-body { margin-top: 16px; padding-top: 14px; border-top: 1px solid var(--dsw-alias-border-l4); }
...
`;
    ...
    function SettingsSection(props) {
      ...
      return react.createElement("div", { className: "sst-settings" },
        ...
        react.createElement("section", { className: "sst-card sst-model-card" }, children.slice(0, shapeIndex)),
        react.createElement("section", { className: "sst-card" }, children[shapeIndex]),
        react.createElement("section", { className: "sst-card sst-advanced" }, children[advancedIndex]),
        children[batchIndex],
