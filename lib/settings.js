...
export function resolveTitleSettings(raw) {
    ...
    const value = raw;
    if (value.showSessionId !== undefined && typeof value.showSessionId !== "boolean") {
        throw new TypeError("smart-session-title: settings.showSessionId must be a boolean");
    }
    ...
    return Object.freeze({
        ...
        showSessionId: value.showSessionId !== false,
        mode,
        provider,
        model,
        timeoutMs,
